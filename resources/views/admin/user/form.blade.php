...
<script>
    function dropdown() {
                return {
                    ...
                    loadOptions() {
                        const options = document.getElementById('perm').options;
            ...
            @if (session('status'))
                ...
                <form method="POST">
                    ...
                    <div class="relative inline-flex">
                        ...
                        <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" id="user" name="user">
                    ...
                    <select x-cloak id="perm" name="perm[]">
                        @foreach($role as $rle)
                        <option value="{{ $rle->id }}">{{ $rle->name }}</option>
                        @endforeach
                    </select>

                    <div x-data="dropdown()" x-init="loadOptions()" class="w-full flex flex-col  h-64 mx-auto">
